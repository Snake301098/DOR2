...
mob_name = "lordakium"
sprite_index=lordakium_spr
health_def=300000;                         //Îïðåäåëåíèå ìàêñèìàëüíîãî çäîðîâüÿ ìîáà.
...
range=480                               //Äàëüíîñòü àòàêè.
ship_speed=2*230/280;;                           //Ñêîðîñòü ìîáà.
money=102400*global.GAMERATE;                               //Íàãðàäà çà ìîáà ââèäå äåíåã.
damage=3000;                              //Êàê áîëüíî êóñàåòñÿ ìîá.
...
CREDITS = 204800*global.GAMERATE;
URIDIUM = 64*global.GAMERATE;
followHP = health_def;
