...
*/
case lv1_1:  //MMO
    {teleport1=instance_create_depth(14960/scale,8960/scale,50,portal_object);
...
{
{
    teleport10=instance_create_depth(8000/scale,5000/scale,50,portal_object);
    teleport10.map1=lv1_1;
    teleport10.map2=TDM; 
    teleport10.sprite_index=jpa_portal_spr;
    teleport10.visible=true
    teleport10.tox=irandom_range(6400/2 - 300, 6400/2 + 300);
    teleport10.toy=irandom_range(4000/2 - 300, 4000/2 + 300);
}
if global.alphaonmap=1 and global.alphawave <=10 then
{    
    teleport6=instance_create_depth(3100/scale,1000/scale,50,portal_object);
...
case lv3_1:  //VRU
    ...
    teleport2=instance_create_depth(1024/scale,1024/scale,50,portal_object);
...
if global.alphaonmap=1 and global.alphawave <=10 then
{    
    teleport6=instance_create_depth(12800/scale,8900/scale,50,portal_object);
...
case lv2_1:  //EIC
    {teleport3=instance_create_depth(1024/scale,8960/scale,50,portal_object);  //409 3584
...
if global.alphaonmap=1 and global.alphawave <=10  then
{    
    teleport6=instance_create_depth(12800/scale,1000/scale,50,portal_object);
...
{    
    ...
    ///////////////////////MMO///////////////////////////
case lv1_2: 
    {teleport1=instance_create_depth(1024/scale,1024/scale,50,portal_object);
    teleport1.map1=lv1_1;
    teleport1.map2=lv1_2;
    teleport1.tox=14960/scale;
    teleport1.toy=8960/scale;
    teleport2=instance_create_depth(14960/scale,1024/scale,50,portal_object);
...
case lv1_3: 
    {teleport2=instance_create_depth(1024/scale,8960/scale,50,portal_object);
    teleport2.map1=lv1_2;
    teleport2.map2=lv1_3;
    teleport2.tox=14960/scale;
    teleport2.toy=1024/scale;
    ...
    teleport1.tox=14960/scale;
    teleport1.toy=1024/scale;
    teleport3=instance_create_depth(14960/scale,1024/scale,50,portal_object);
...
case lv1_4: 
    ...
    teleport1.tox=14960/scale;
    teleport1.toy=8960/scale;
    teleport2=instance_create_depth(14960/scale,5000/scale,50,portal_object);
    ...
    teleport4=instance_create_depth(14960/scale,8960/scale,50,portal_object);
    ...
    {teleport1=instance_create_depth(14960/scale,5000/scale,50,portal_object);
    teleport1.map1=lv1_5;
    teleport1.map2=lv4_4;
    teleport1.tox=7750*0.8;
    teleport1.toy=5000*0.8;
    teleport2=instance_create_depth(8000/scale,8960/scale,50,portal_object);
    ...
    teleport3.tox=14960/scale;
    teleport3.toy=1024/scale;
    teleport4=instance_create_depth(1024/scale,1024/scale,50,portal_object);
    ...
    {teleport1=instance_create_depth(1024/scale,8960/scale,50,portal_object);
    teleport1.map1=lv1_8;
    teleport1.map2=lv1_6;
    teleport1.tox=14960/scale;
    teleport1.toy=1024/scale;
    teleport2=instance_create_depth(14960/scale,8960/scale,50,portal_object);
    teleport2.map1=lv1_5;
    ...
    {teleport1=instance_create_depth(14960/scale,1024/scale,50,portal_object);
    teleport1.map1=lv1_5;
...
case lv3_2: 
    ...
    teleport1.tox=14960/scale;
    teleport1.toy=8960/scale;
    teleport3=instance_create_depth(1024/scale,1024/scale,50,portal_object);
...
case lv3_4: 
    ...
    teleport3.tox=1024/scale;
    teleport3.toy=8960/scale;
    teleport4=instance_create_depth(8000/scale,1024/scale,50,portal_object);
    ...
    teleport2.tox=14960/scale;
    teleport2.toy=8960/scale;
    teleport1=instance_create_depth(1024,8960/scale,50,portal_object);
...
case lv2_4: 
    ...
    teleport3.tox=1024/scale;
    teleport3.toy=1024/scale;
    teleport4=instance_create_depth(14960/scale,1024/scale,50,portal_object);
...
case lv4_1:  //PVP
    ...
    {teleport1=instance_create_depth(1024/scale,5000/scale,50,portal_object);
    teleport1.map1=lv1_4;
    ...
    teleport4=instance_create_depth(8000/scale,5000/scale,50,portal_object);
...
case lv4_2:
    ...
    {teleport1=instance_create_depth(8000/scale,1024/scale,50,portal_object);
    teleport1.map1=lv2_4;
    teleport1.map2=lv4_2;
    teleport1.tox=8000/scale;
    teleport1.toy=8960/scale;
    teleport2=instance_create_depth(8000/scale,5000/scale,50,portal_object);
...
case lv4_3:
    ...
    teleport1.tox=8000/scale;
    teleport1.toy=1024/scale;
    teleport3=instance_create_depth(8000/scale,5000/scale,50,portal_object);
    teleport3.map1=lv4_4;
    teleport3.map2=lv4_3;
    teleport3.tox=8250*0.8;
    teleport3.toy=5250*0.8;
    teleport2=instance_create_depth(512/scale,512/scale,50,portal_object);
    teleport2.map1=lv4_3;
    teleport2.map2=lv4_2;
    teleport2.tox=14960/scale;
    teleport2.toy=8960/scale;
    teleport4=instance_create_depth(512/scale,9488/scale,50,portal_object);
    teleport4.map1=lv4_3;
    teleport4.map2=lv4_1;
    teleport4.tox=14960/scale;
    teleport4.toy=8960/scale; break;}
...
case lv4_4:
    ...
    {teleport4=instance_create_depth(7750*0.8,5000*0.8,50,portal_object);
    teleport4.map1=lv4_4;
    teleport4.map2=lv4_1;
    teleport4.tox=8000/scale;
    teleport4.toy=5000/scale;
    teleport2=instance_create_depth(8250*0.8,4750*0.8,50,portal_object);
    teleport2.map1=lv4_4;
    teleport2.map2=lv4_2;
    teleport2.tox=8000/scale;
    teleport2.toy=5000/scale;
    teleport3=instance_create_depth(8250*0.8,5250*0.8,50,portal_object);
    teleport3.map1=lv4_4;
    teleport3.map2=lv4_3;
    teleport3.tox=8250/scale;
    teleport3.toy=5250/scale;
    teleport1=instance_create_depth(1024*0.8,5000*0.8,50,portal_object);
    teleport1.map1=lv1_5;
    teleport1.map2=lv4_4;
    teleport1.tox=14960/scale;
    teleport1.toy=5000/scale;
    teleport5=instance_create_depth(8000*0.8,1024*0.8,50,portal_object);
    teleport5.map1=lv2_5;
    teleport5.map2=lv4_4;
    teleport5.tox=1024/scale;
    teleport5.toy=8960/scale;
    teleport6=instance_create_depth(8000*0.8,8960*0.8,50,portal_object);
    ...
    {teleport1=instance_create_depth(8000*0.8,1024*0.8,50,portal_object);
    teleport1.map1=lv2_5;
    teleport1.map2=lv4_5;
    teleport1.tox=14960/scale;
    teleport1.toy=8960/scale;
    teleport2=instance_create_depth(1024*0.8,5000*0.8,50,portal_object);
    teleport2.map1=lv1_5
    teleport2.map2=lv4_5;
    teleport2.tox=8000/scale;
    teleport2.toy=8960/scale;
    teleport3=instance_create_depth(8000,8960,50,portal_object);
    teleport3.map1=lv3_5;
    teleport3.map2=lv4_5;
    teleport3.tox=14960/scale;
    teleport3.toy=1024/scale; break;}  
