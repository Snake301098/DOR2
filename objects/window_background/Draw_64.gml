...
switch active_tab
{
	...
	case "EQUIPMENT":
	{
		...
		switch active_side_tab
		{
			case "SHIP":
			{
				...
				draw_sprite_ext(shop_icons_spr,24,680,500,1,1,0,c_white,1)
				draw_sprite_ext(hangar_bareer_spr,0,1170,550,4,1.5,90,c_white,1)
				break;
			}
	...
	case "SHOP":
	{
		...
		draw_sprite_ext(window_layer_spr,0,1920/2+85,1080/2+10,2.5,2.1,0,c_white,1)
		draw_sprite_ext(hangar_bareer_spr,0,1170,550,4,1.5,90,c_white,1)
		draw_sprite_ext(hangar_bareer_spr,0,940,550,4,1.5,90,c_white,1)
	...
	case "UPGRADES":
	{
		...
		switch active_side_tab
		{
			case "INVENTORY":
			{
				...
				draw_sprite_ext(window_layer_spr,0,1920/2+85,1080/2+10,2.5,2.1,0,c_white,1)
				draw_sprite_ext(hangar_bareer_spr,0,1170,550,4,1.5,90,c_white,1)
				draw_sprite_ext(hangar_bareer_spr,0,900,550,4,1.5,90,c_white,1)
	...
	case "GG PORTALS":
	{
		...
		switch active_side_tab
		{
			case "ALPHA":
			{
				//LAYERS
				draw_sprite_ext(window_layer_spr,0,1920/2+85,1080/2+10,2.5,2.1,0,c_white,1)
				draw_sprite_ext(hangar_bareer_spr,0,1050,550,4,1.5,90,c_white,1)
