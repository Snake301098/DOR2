...
shield_def=6000;                           //Ìàêñèìàëüíîå êîë-âî ùèòà.
...
damage=200;                              //Êàê áîëüíî êóñàåòñÿ ìîá.
...
passive:=false; 
EPPOINTS:=1600*global.GAMERATE;
HONORPOINTS:=8*global.GAMERATE; 
CREDITS:=1600*global.GAMERATE;
URIDIUM:=4*global.GAMERATE;
