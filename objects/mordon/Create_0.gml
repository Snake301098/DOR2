...
shield_def=10000;                           //Ìàêñèìàëüíîå êîë-âî ùèòà.
...
range=300                               //Äàëüíîñòü àòàêè.
ship_speed=2*125/280;;                           //Ñêîðîñòü ìîáà.
money=102400*global.GAMERATE;                               //Íàãðàäà çà ìîáà ââèäå äåíåã.
damage=400;                              //Êàê áîëüíî êóñàåòñÿ ìîá.
...
CREDITS:=6400*global.GAMERATE;
URIDIUM:=8*global.GAMERATE;
