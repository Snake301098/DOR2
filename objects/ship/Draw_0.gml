...
sprite_index = info(ship_name,"sprite");
...
if instance_exists(gamer.target)
{
	if id = gamer.target
	{
		...
		draw_set_alpha(0.9);draw_healthbar(x-45,y-103,x+45,y-101,own_health/health_def*100,c_gray,c_lime,c_lime,0,1,1);draw_set_alpha(0.9); //+41+25
		...
		if own_shield>0 then{    draw_set_alpha(0.9);draw_healthbar(x-45,y-88,x+45,y-86,own_shield/shield_def*100,c_gray,c_aqua,c_aqua,0,1,1);draw_set_alpha(0.9);} //+41+25
	}
}
